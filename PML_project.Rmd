...
In this report, accelerometer data collected during exercise activity is analyzed, trained and used to predict the outcome of the activity. The data comes from come this source: http://groupware.les.inf.puc-rio.br/har.  Training and testing datasets containing sensor data from different parts of the body in 6 participants are utilized.
